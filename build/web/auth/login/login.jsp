<%-- 
    Document   : login
    Created on : Dec 8, 2020, 5:04:25 PM
    Author     : ChiHab
--%>
...
<body>
    <%
        ...
        if (request.getAttribute("msgerr")!=null) {
                msgerr = request.getAttribute("msgerr").toString();
            }
        else{
            msgerr = "";
        }
        ...
        <div class="row flex-grow">
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
              ...
              <form class="pt-3" action="<%=request.getContextPath()%>/connection">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <div class="input-group-prepend bg-transparent">
                      ...
                      <input type="text" class="form-control form-control-lg border-left-0" id="exampleInputEmail" placeholder="Username" name="user">
                  </div>
                </div>
                <div class="form-group">
